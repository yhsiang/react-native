...
/*package*/ class NativeAnimatedNodesManager {
  ...
  public void stopAnimation(int animationId) {
    // in most of the cases there should never be mmore than a few active animations running at the
    // same time. Therefore it does not make much of a sense to crate an animationId -> animation
